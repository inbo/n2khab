...
- processed data sources:
    ...
    - `GRTSmh_base4frac` ([Zenodo-link](https://doi.org/10.5281/zenodo.3354401)): is like a mirror to `GRTSmaster_habitats`, holding the ranking numbers as base 4 fractions (for more details see the `read_GRTSmh_base4frac()` documentation)
