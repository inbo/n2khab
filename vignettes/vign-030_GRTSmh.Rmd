...
- processed data sources:
    ...
    - `GRTSmh_diffres`: file collection composed of nine monolayered GeoTIFF files plus a GeoPackage with nine polygon layers. They provide the hierarchical levels 1 to 9 of the `GRTSmh_brick` data source at the corresponding spatial resolution, i.e. at lower resolutions than `GRTSmh_brick` (for more details see the [read_GRTSmh_diffres() documentation](../html/read_GRTSmh_diffres.html))
...
#> source     : /media/floris/DATA/PROJECTS/09685_NatuurlijkMilieu/160 Bewerkingen en resultaat/Repos_en_data/n2khab-inputs/data/20_processed/GRTSmh_diffres/GRTSmh_diffres.5.tif 
#> names      : level5 
#> values     : 1, 65529  (min, max)
```

Alternatively, a dissolved, polygonized version of the corresponding `GRTSmh_brick` level can be returned as an `sf` object:
