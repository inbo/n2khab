...
You can also read the explanations for levels of the code variables `bsm_mo_substr`, `bsm_mo_tex`, `bsm_mo_drain` etc. from the data source and insert them as columns (with the corresponding order of factor levels).
...
```{r paged.print=FALSE}
tibble(drain_levels = levels(sm_simple$bsm_mo_drain),
