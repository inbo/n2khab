...
1. From your working directory, use [fileman_folders()](../html/fileman_folders.html) to specify the desired location (using the function's arguments).
...
3. From the cloud storage, **download** the respective data files of a data source.
