...
- `schemes`: list of schemes [^scheme] for N2KHAB monitoring programmes or other N2KHAB projects (documentation links: [this website](../reference/schemes.html) / [installed package](../html/schemes.html))
- `scheme_types`: lists the types that belong to each N2KHAB scheme, and optionally defines typegroups within a scheme (documentation links: [this website](../reference/scheme_types.html) / [installed package](../html/scheme_types.html))
...
The `read_scheme_types()` function provides the extra ability to _toggle_ the presence of most textual information, because these comprise many extra variables (combining all additional information of the concerned schemes _and_ the types).
