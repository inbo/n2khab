#' Return the data source \code{habitatmap_processed}
#'
...
#'     }
#'
#' @family functions involved in processing the \code{habitat_map} data source
#'
#' @references
#'
...
read_habitatmap <-
    function(path,
        ...
        result <- list(polygons = habmap_polygons,
                       patches = habmap_patches)
